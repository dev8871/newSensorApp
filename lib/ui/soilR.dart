...
class soilR extends StatefulWidget {
  final String title;

  const soilR({super.key, required this.title});

  @override
  State<soilR> createState() => _soilRState();
}

class _soilRState extends State<soilR> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => soilPage()));
          },
        ),
